...
from iqa.proposed import fusion_model
from utils.evaluation import eval_game, eval_relative
from PIL import Image


parser = argparse.ArgumentParser(description='Test')
parser.add_argument('--data-dir', default='/media/panyi/dd67419f-4b06-4cc1-a57e-0706577875075/Crowd Counting/RGBT-CC',
                        help='training data directory')
parser.add_argument('--save-dir', default='/media/panyi/dd67419f-4b06-4cc1-a57e-0706577875075/Crowd Counting/RGBT-CC/HFFNetfem',
                        help='model directory')
parser.add_argument('--model', default='best_model_26.pth'
                    , help='model name')
...
if __name__ == '__main__':
    ...
    # print(type(type(outputs)))
            ...
            path = os.path.join('/media/panyi/dd67419f-4b06-4cc1-a57e-0706577875075/Crowd Counting/RGBT-CC/hffnetfem',name[0]+'.png')
